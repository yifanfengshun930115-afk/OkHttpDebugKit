...
/**
 * No-op build variant of the runtime options. It keeps the same public API as the
 * debug artifact so release builds can compile against a harmless implementation.
 */
